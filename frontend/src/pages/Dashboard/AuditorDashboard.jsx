...
// This component renders the auditor dashboard for the inventory management system. It provides an overview of key metrics, recent audit activities, and system information relevant to auditors. The dashboard includes sections for system compliance, recent administrative decisions, and a detailed audit trail of transactions. It also features a tabbed interface to switch between different views of the dashboard, allowing auditors to easily access the information they need for their audits and reviews.
                ...
                <List dense>
                  <ListItem>
                    <ListItemText
                      primary="Environment"
                      secondary={
                        stats?.systemInfo?.environment || "development"
                      }
                    />
                    <Chip
                  ...
                  <ListItem>
                    <ListItemText
                      ...
                      secondary={
                        stats?.systemInfo?.databaseStatus || "Connected"
                      }
                    />
                    <Chip
              ...
              <Paper sx={{ p: 3 }}>
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  >
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 600 }}>
                      {stats?.systemInfo?.memoryUsage?.used || 0}MB /{" "}
                      {stats?.systemInfo?.memoryUsage?.total || 0}MB
                    </Typography>
                  </Box>
                  <LinearProgress
                    variant="determinate"
                    value={
                      stats?.systemInfo?.memoryUsage
                        ? (stats.systemInfo.memoryUsage.used /
                            stats.systemInfo.memoryUsage.total) *
                          100
                        : 0
                    }
                      ...
                      secondary={
                        <Box>
                          <Typography variant="caption" display="block">
                            By: {activity.user} ({activity.userRole}) •{" "}
            ...
            >
              <Paper sx={{ p: 3, minHeight: "500px" }}>
                <Typography
                  ...
                  sx={{ display: "flex", alignItems: "center" }}
                >
                  <DecisionIcon sx={{ mr: 1 }} /> Recent Administrative
                  Decisions
                </Typography>
                <Divider sx={{ mb: 2 }} />
                      ...
                      <ListItem key={index} divider>
                        <ListItemText
                          ...
                          secondary={
                            <Box>
                              <Typography variant="caption" display="block">
                                {decision.department} • Requested by:{" "}
                                {decision.requestedBy}
                              </Typography>
                              {decision.approvedBy && (
                                <Typography variant="caption" display="block">
                                  Processed by: {decision.approvedBy} (
                ...
                <Paper sx={{ p: 3, flex: 1 }}>
                  ...
                  <List dense>
                    ...
                    <ListItem>
                      ...
                      <Typography variant="body2" color="text.secondary">
                        {new Date(
                          stats?.systemOverview?.lastAuditDate || Date.now(),
                        ).toLocaleDateString()}
                      </Typography>
                    </ListItem>
                  </List>
        ...
        >
          <Tab
            icon={
              <Badge
                badgeContent={
                  stats?.complianceMetrics?.pendingRequisitions > 0
                    ? stats.complianceMetrics.pendingRequisitions
                    : null
                }
                color="warning"
              >
          ...
          <Tab
            icon={
              <Badge
                badgeContent={stats?.auditTrail?.length || null}
                color="primary"
              >
                <AuditIcon />
              </Badge>
